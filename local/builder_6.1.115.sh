...
# ===== 设置自定义参数 =====
echo "===== 欧加真MT6989通用6.1.115 A15 (mtk特供) OKI内核本地编译脚本 By Coolapk@cctv18 ====="
echo ">>> 读取用户配置..."
SOC_BRANCH=${SOC_BRANCH:-mt6989}
MANIFEST=${MANIFEST:-oppo+oplus+realme}
read -p "请输入自定义内核后缀（默认：android14-oki-xiaoxiaow）: " CUSTOM_SUFFIX
CUSTOM_SUFFIX=${CUSTOM_SUFFIX:-android14-oki-xiaoxiaow}
